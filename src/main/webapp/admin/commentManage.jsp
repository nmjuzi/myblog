         ...
         */
         function formatBlogTile(val,row) {
             if(val.id == null){
                 ...
                 return "<a href='${myblog}/blog/articles/"+val.id+".html' target='_blank'>"+val.title+"</a>";
             }
         }
        /**
         * 格式化审核状态
        ...
        function deleteComment() {
            ...
            if( selectRows.length == 0){
                ...
                $.messager.confirm('系统信息',"<font color=red>您确定要删除选中的"+selectRows.length+"条数据么？</font>",function(r){
                    if(r){
                        $.post('${myblog}/admin/comment/delete.do',{ids:ids},function (result) {
                            if(result.success){
...
<body style="margin: 1px; font-family: microsoft yahei">
    <table id="dg" title="评论信息管理" class="easyui-datagrid" fitColumns="true" pagination="true"
           url="${myblog}/admin/comment/list.do" toolbar="#tb">
        <thead>
            <tr>
