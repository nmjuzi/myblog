...
<div class="data_list">
	...
	<div class="nickName"><strong><font style="color: #EE6A50">昵称：${currentUser.nickName }</font></strong></div>
	<%-- <div class="visitNum">访问量：6666</div>  --%>
	<div class="userSign">『<strong><font style="color: #EE6A50">${currentUser.sign }</font></strong>』</div>
</div>
