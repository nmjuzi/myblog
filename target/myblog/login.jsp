...
body {
	/* background: #ebebeb; */
	background:url("${pageContext.request.contextPath}/static/images/a.jpeg")no-repeat;
...
.fugai {
	background:
		url("${pageContext.request.contextPath}/static/images/fugai.png")
		no-repeat;
	width: 97px;
	height: 92px;
	position: absolute;
...
<SCRIPT type="text/javascript">
	$(function() {
		...
		$("#password").focus(function() {
			...
			$("#fugai").attr("style", "display:block");
		});
		//失去焦点
...
<body>
	...
	<form action="${pageContext.request.contextPath}/blogger/login.do"
		...
		<DIV
			style="background: rgb(251, 243, 241); margin: 250px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
			<DIV style="width: 165px; height: 96px; position: absolute;">
				<DIV class="tou" id="tou"></DIV>
				<DIV class="fugai" id="fugai"></DIV>
			...
			<p style="padding: 10px 0px 10px; position: relative;">
				<span><font color="#FF5722" id="error">${errorInfo }</font></span> 
			</p>
			<p>
					<SPAN
						style="float:center;"> 
						<input type="submit"
						style="background: rgb(240, 140, 86); padding: 7px 10px; border-radius: 4px; border: 1px solid #FF9800; border-image: none; color: rgb(255, 255, 255); font-weight: bold;"
						value="登录" />
					</SPAN>
			</p>
			<!-- <DIV
				...
				<P style="margin: 0px 35px 20px 45px;">
					<SPAN style="float: left;">老王和小平的个人博客系统</SPAN> 
					
				</P>
			</DIV> -->
		</DIV>
	</form>
	<div style="text-align:center;padding-top: 170px">Copyright ©
		1994-9999 老王和小平的个人博客系统  版权所有 >_<</div>
</body>
</html>