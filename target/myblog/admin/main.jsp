...
<head>
    ...
    <script>
        ...
        function logout(){
        	//退出  需要清空session并返回登录页面
        	var a=confirm("确认退出吗？");
        	if(a==true){
        		 $.post("${myblog}/blogger/logout.do",
                         {
                         }, function(result) {
                             if (result.success) {
                                 window.location.href="/myblog/login.jsp";
                                 clearValues();
                             } else {
        ...
        function submitData() {
            $("#fm").form('submit',{
                url:'${myblog}/admin/blogger/modtifyPassword.do',
                onsubmit:function () {
...
<div region="north" style="height: 78px; background-color: rgb(242, 242, 242)">
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <td valign="bottom" align="right" width="45%">
                <font size="3" color="#1e90ff">&nbsp;&nbsp;<strong>${currentUser.userName }</strong>欢迎您！今天是<span id="date_show" ></span></font>
            </td>
            <td align="right" width="5%">
			<img style="width:50px;height:50px"
			src="${pageContext.request.contextPath}/static/userImages/${currentUser.imageName}" />
			</td>
        </tr>
    </table>
</div>
...
<div region="south" style="height: 25px;padding: 5px" align="center">
    Copyright © 1994-9999 老王和小平的博客系统 版权所有
</div>
</body>
<script type="text/javascript">
var date  = new Date();
...
document.getElementById("date_show").innerHTML = today;
</script>
</html>
