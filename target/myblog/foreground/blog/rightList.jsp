...
<div class="data_list">
	...
	<div class="user_image">
		<img
			src="${pageContext.request.contextPath}/static/userImages/${blog.blogger.imageName}" />
	</div>
	<div class="nickName"><strong><font style="color: #EE6A50">昵称：${blog.blogger.nickName}</font></strong></div>
	<%-- <div class="visitNum">访问量：6666</div>  --%>
	<div class="userSign">『<strong><font style="color: #EE6A50">${blog.blogger.sign }</font></strong>』</div>
</div>
